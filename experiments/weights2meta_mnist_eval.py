...
from experiments.weights2meta_mnist_train import (  # type: ignore
    TARGET_FIELDS,
    list_run_dirs,
    load_example,
    WeightsTransformer,
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Evaluate MNIST weights2meta model.")
    ap.add_argument("--runs-base", type=str, default="runs/mnist")
    ap.add_argument("--model", type=str, default="runs/mnist_weights2meta/weights2meta.pt")
    ap.add_argument("--stats", type=str, default="runs/mnist_weights2meta/y_norm.json")
